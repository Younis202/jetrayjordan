...
const testimonials = [
  {
    ...
    content:
      "Jetray Jordan made my business travel seamless. Their corporate booking platform saved us 30% on travel costs and the 24/7 support is incredible. Best travel agency we've worked with!",
    rating: 5,
    stats: {
      flights: "50+",
      savings: "30%",
  ...
  },
  {
    ...
    content:
      "Our family vacation to Europe was perfectly planned by Jetray Jordan. From flights to hotels, everything was seamless. The kids loved the special arrangements they made for us!",
    rating: 5,
    stats: {
      destinations: "5",
      savings: "25%",
  ...
  },
  {
    ...
    content:
      "Our honeymoon in the Maldives was a dream come true! Jetray Jordan arranged everything perfectly - from first-class flights to overwater villa. Absolutely magical experience!",
    rating: 5,
    stats: {
      romance: "10/10",
      service: "Excellent",
    ...
    <section id="testimonials" className="relative py-24 overflow-hidden">
      ...
      <div className="container relative">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          ...
          >
            Don't just take our word for it. See how Jetray Jordan has created
            unforgettable travel experiences for thousands of satisfied
            customers worldwide.
          </motion.p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {testimonials.map((testimonial, index) => (
            ...
            >
              {/* Gradient Background */}
              <div
                className={`absolute inset-0 bg-gradient-to-br ${testimonial.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500 rounded-2xl`}
              />

              {/* Industry Badge */}
              <div className="absolute -top-3 left-6">
                <div
                  className={`inline-flex items-center gap-1 bg-gradient-to-r ${testimonial.gradient} px-3 py-1 rounded-full text-xs font-semibold text-white shadow-lg`}
                >
              ...
              <div className="pt-4">
                ...
                <div className="flex items-center gap-4 mb-6">
                  <div className="relative">
                    <div
                      className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${testimonial.gradient} p-1`}
                    >
                ...
                <div className="grid grid-cols-3 gap-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                  <div className="text-center">
                    ...
                    <div className="text-lg font-bold text-gray-900 dark:text-white">
                      {testimonial.stats.flights ||
                        testimonial.stats.destinations ||
                        testimonial.stats.romance}
                    </div>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-lg font-bold text-gray-900 dark:text-white">
                      {testimonial.stats.satisfaction ||
                        testimonial.stats.experience ||
                        testimonial.stats.memories}
                    </div>
                  </div>
                </div>
              </div>
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join thousands of satisfied travelers who've discovered the world
              with Jetray Jordan. Your next amazing journey could be just a
              click away.
            </p>
