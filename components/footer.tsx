...
const quickLinks = [
  ...
  { href: '/destinations', label: 'Destinations', icon: Building2 },
  { href: '/deals', label: 'Flight Deals', icon: Globe },
  { href: '/services', label: 'Services', icon: BarChart },
  { href: '/contact', label: 'Contact', icon: MessageCircle },
  { href: '/blog', label: 'Travel Blog', icon: Star }
];
...
const destinations = [
  { name: 'Dubai, UAE', href: '/destinations/dubai', discount: '25% OFF' },
  { name: 'Paris, France', href: '/destinations/paris', discount: '30% OFF' },
  { name: 'Tokyo, Japan', href: '/destinations/tokyo', discount: '20% OFF' },
  { name: 'New York, USA', href: '/destinations/newyork', discount: '35% OFF' },
  { name: 'London, UK', href: '/destinations/london', discount: '28% OFF' },
  { name: 'Bali, Indonesia', href: '/destinations/bali', discount: '40% OFF' }
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
            ...
            <div className="lg:col-span-4 space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Join 500K+ travelers who trust us to create unforgettable journeys worldwide. 
                  Book your next adventure with exclusive deals and premium service.
                </p>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-r from-primary/10 to-blue-500/10 border border-primary/20">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Find your perfect flight with exclusive deals and instant booking
                </p>
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="space-y-4 pt-4 border-t border-border/50">
                ...
                <div className="space-y-3">
                  <a
                    href="tel:+15155065027"
                    className="flex items-center text-muted-foreground hover:text-primary transition-colors group"
                  >
                    <Phone className="h-4 w-4 mr-2 text-primary" />
                    <span className="group-hover:underline">+1 (515) 506-5027</span>
                  </a>
                  <a
                    href="mailto:info@jetrayjordan.com"
                    className="flex items-center text-muted-foreground hover:text-primary transition-colors group"
                  >
                    <Mail className="h-4 w-4 mr-2 text-primary" />
                    <span className="group-hover:underline">info@jetrayjordan.com</span>
                  </a>
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
              <div className="flex items-center gap-4">
                <p className="text-sm text-muted-foreground">
                  © {new Date().getFullYear()} Jetray Jordan. All rights reserved.
                </p>
                <div className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-emerald-500" />
                  <span className="text-xs text-emerald-600 font-medium">IATA Certified</span>
                </div>
              </div>
